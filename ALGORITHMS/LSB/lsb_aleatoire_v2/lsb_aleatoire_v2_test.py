...
from ALGORITHMS.LSB.lsb_aleatoire_v2.lsb_aleatoire_v2 import lsb_aleatoire_decodeur_v2, lsb_aleatoire_encodeur_v2
...
if __name__ == "__main__":
    ...
    image1_stego = lsb_aleatoire_encodeur_v2(str(image1_originale_path), message1_original, header_len16, cle_pixels, cle_canal)
    ...
    message1_stego = lsb_aleatoire_decodeur_v2(str(image1_stego_path), header_len16, cle_pixels, cle_canal)
