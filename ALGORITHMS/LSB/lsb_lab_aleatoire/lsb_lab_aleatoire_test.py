...
from ALGORITHMS.LSB.lsb_lab_aleatoire.lsb_lab_aleatoire import lsb_lab_aleatoire_decodeur, lsb_lab_aleatoire_encodeur
...
if __name__ == "__main__":
    ...
    image1_stego = lsb_lab_aleatoire_encodeur(str(image1_originale_path), message1_original, header_len16, cle_pixels, cle_canal)
    ...
    message1_stego = lsb_lab_aleatoire_decodeur(str(image1_stego_path), header_len16, cle_pixels, cle_canal)
